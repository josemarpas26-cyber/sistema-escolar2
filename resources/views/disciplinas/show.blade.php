...
<div class="max-w-4xl space-y-6">
    <x-card title="Informacoes da Disciplina" icon="fas fa-info-circle">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <div class="mt-1">
                    @if($disciplina->coordenador)
                        <a href="{{ route('users.show', $disciplina->coordenador) }}" class="text-primary-600 font-medium hover:text-primary-700">
                            {{ $disciplina->coordenador->name }}
                        </a>
                    @else
                        <x-badge type="gray">Sem coordenador definido</x-badge>
                    @endif
                </div>
            </div>
            ...
            <div>
                <span class="text-gray-600">Classes onde e lecionada:</span>
                <div class="flex flex-wrap gap-2 mt-1">
                    @if($disciplina->leciona_10)
                        <x-badge type="info">10a Classe</x-badge>
                    @endif
                    @if($disciplina->leciona_11)
                        <x-badge type="info">11a Classe</x-badge>
                    @endif
            ...
            <div>
                <span class="text-gray-600">Data de criacao:</span>
    ...
    <x-card title="Ano Terminal por Curso" icon="fas fa-sitemap">
        <p class="text-sm text-gray-600 mb-4">
            ...
            Configuracao do ano em que esta disciplina termina para cada curso.
        </p>
