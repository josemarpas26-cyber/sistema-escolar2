...
<x-card class="mb-6">
    <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
        <input type="text" name="search" value="{{ request('search') }}"
               placeholder="Pesquisar por nome..." class="input">
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    <th class="px-6 py-3.5 text-left text-xs font-medium text-gray-500 uppercase">Professor</th>
                    <th class="px-6 py-3.5 text-left text-xs font-medium text-gray-500 uppercase">Disciplinas</th>
                    <th class="px-6 py-3.5 text-center text-xs font-medium text-gray-500 uppercase">Turmas</th>
