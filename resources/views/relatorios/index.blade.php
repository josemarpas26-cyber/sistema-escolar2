...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <x-card title="Boletim do Aluno" icon="fas fa-file-pdf">
        ...
        <a href="{{ route('relatorios.boletim') }}" class="btn btn-primary w-full">
    ...
    <x-card title="Pauta da Turma" icon="fas fa-table">
        ...
        <a href="{{ route('relatorios.pauta', ['turma' => 1, 'disciplina' => 1]) }}" class="btn btn-primary w-full">
            <i class="fas fa-download mr-2"></i>
            Gerar Pauta
        </a>
    </x-card>
    ...
    <x-card title="Histórico Académico" icon="fas fa-history">
        ...
        <a href="{{ route('relatorios.historico') }}" class="btn btn-primary w-full">
            <i class="fas fa-download mr-2"></i>
            Gerar Histórico
        </a>
    </x-card>
